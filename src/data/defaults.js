...
export const DEFAULT_LOCATION = {
  ...
  mapLink: "https://kko.to/TFXVT1mqpj",
};
...
export const DEFAULT_KOLAS = [
  { id: 1, code: "KS B ISO 9283", title: "산업용 머니플레이팅 로봇 성능 항목 및 시험방법", target: "산업용 로봇 완성품 및 로봇 암 제조사, 성능 인증이 필요한 협동로봇 기업", desc: "로봇의 포즈 정확도, 반복 정밀도, 경로 정확도 등\n핵심 성능 항목 측정 방법 규정" },
  { id: 2, code: "KS C IEC 60034-1", title: "회전기기 제1부: 정격 및 성능", target: "모터, 발전기 등 회전기기 제조사, 로봇 액추에이터 모듈 개발 기업", desc: "회전기기의 정격, 성능, 시험방법에 관한 기본 요구사항 규정" },
  { id: 3, code: "KS C IEC 60034-2-1", title: "회전기기 제2-1부: 손실 및 효율을 측정하는 표준 시험방법", target: "고효율 모터 개발 기업, 에너지 효율 인증이 필요한 로봇 부품 기업", desc: "회전기기의 손실 및 효율을 측정하기 위한 표준 시험방법 규정" },
];
