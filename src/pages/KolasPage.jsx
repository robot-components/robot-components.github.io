...
const KOLAS_HEADER = { label: "KOLAS", title: "KOLAS 인정 규격 안내", sub: "공인시험기관으로서 아래 규격에 따른 공인 시험성적서를 발급합니다." };
const KOLAS_CONTACT = { title: "문의하기", desc: "공인 시험성적서 발급 및 시험평가 관련 문의 사항은 아래 이메일로 연락해 주세요." };
