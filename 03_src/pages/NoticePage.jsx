  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <PageHeader label="공지사항" title="공지사항" sub="센터 운영 관련 공지 및 사업 안내를 확인하세요." />
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <div style={{ marginBottom: 12 }}>
            {noticeCatEditMode ? (
              ...
              <button onClick={() => setNoticeCatEditMode(true)} style={{ ...btn("#f8fafc", "#475569"), border: "0.5px solid #cbd5e1", fontSize: 12, marginBottom: 12 }}><Edit2 size={13} />카테고리 편집</button>
            )}
          </div>
      ...
      {/* 공지 상세 or 목록 */}
      {noticeDetail ? (
        <div style={{ background: "#fff", borderRadius: 12, border: "0.5px solid #e2e8f0", padding: 32 }}>
