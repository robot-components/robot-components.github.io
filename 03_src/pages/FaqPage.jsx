...
import { Edit2, Plus, Trash2, GripVertical, ChevronDown, ChevronUp, Save } from "lucide-react";
  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <PageHeader label="FAQ" title="자주 묻는 질문 (FAQ)" sub="궁금하신 점을 빠르게 찾아보세요." />
      ...
      {adminMode && (
        <div style={{ marginBottom: 20 }}>
          ...
          {faqCatEditMode ? (
            ...
            <button onClick={() => setFaqCatEditMode(true)} style={{ ...btn("#f8fafc", "#475569"), border: "0.5px solid #cbd5e1", fontSize: 12, marginBottom: 12 }}><Edit2 size={13} />카테고리 편집</button>
          )}
